...
void c_Output::graphicMaker(int flagInt, int colourFlag)
{
	...
	for (size_t g = 0; g < currentCopy.pages.size(); g++)
	{
		...
		if (flagInt == 0) { pythonScript = pythonScript + "Type_" + filenameStub + "_" + std::to_string(currentCopy.pages[g].position) + ".png\", bbox_inches='tight')\n"; }
		else if (flagInt == 1) { pythonScript = pythonScript + "Location_" + filenameStub + "_" + std::to_string(currentCopy.pages[g].position) + ".png\", bbox_inches='tight')\n"; }
	}

	// Complete python file with legends
	pythonScript = pythonScript + "lvalues = [[50,50,50,50,50]]\nlvalues_colour = [[0,3,5,2,9]]\nlvalues_text = [['Location Only', 'Ambiguous Publication','Named Publication', 'Correspondence','Undetermined']]\nlmax_cols = len(lvalues)\nlmax_rows = len(lvalues[0])\nlvalues_sums = [sum([r[i] for r in lvalues]) for i in range(lmax_rows)]\nlvalues_norm = [[v/lvalues_sums[i] for i, v in enumerate(row)] for row in lvalues]\nfig, ax = plt.subplots(1, figsize=(50, 2))\nfor row_num in range(lmax_cols):\n\tax.bar(range(lmax_rows), lvalues_norm[row_num], bottom=[sum([lvalues_norm[i][j] for i in range(row_num)]) for j in range(lmax_rows)], width=1, edgecolor='#000000',  color=[plt.get_cmap('Set1')(i) for i in lvalues_colour[row_num]])\nax.set_xlim(-0.5, lmax_rows-.5)\nax.set_xticks([])\nax.set_yticks([])\nax.set_ylim(0, 1)\nfor x in range(lmax_rows):\n\tfor y in range(lmax_cols):\n\t\tif lvalues[y][x] != 0.0:\n\t\t\tax.text(x, y + .5, lvalues_text[y][x], fontsize = 32, ha='center', va='center', bbox=dict(facecolor='white', edgecolor='white', boxstyle='round,pad=.1'))\nplt.savefig('Colour_Type_Legend.png', bbox_inches='tight')\n\nlvalues = [[50,50,50,50,50]]\nlvalues_colour = [[0,50,100,175,225]]\nlvalues_text = [['Location Only', 'Ambiguous Publication','Named Publication', 'Correspondence','Undetermined']]\nlmax_cols = len(lvalues)\nlmax_rows = len(lvalues[0])\nlvalues_sums = [sum([r[i] for r in lvalues]) for i in range(lmax_rows)]\nlvalues_norm = [[v/lvalues_sums[i] for i, v in enumerate(row)] for row in lvalues]\nfig, ax = plt.subplots(1, figsize=(50, 2))\nfor row_num in range(lmax_cols):\n\tax.bar(range(lmax_rows), lvalues_norm[row_num], bottom=[sum([lvalues_norm[i][j] for i in range(row_num)]) for j in range(lmax_rows)], width=1, edgecolor='#000000',  color=[plt.get_cmap('Greys')(i) for i in lvalues_colour[row_num]])\nax.set_xlim(-0.5, lmax_rows-.5)\nax.set_xticks([])\nax.set_yticks([])\nax.set_ylim(0, 1)\nfor x in range(lmax_rows):\n\tfor y in range(lmax_cols):\n\t\tif lvalues[y][x] != 0.0:\n\t\t\tax.text(x, y + .5, lvalues_text[y][x], fontsize = 32, ha='center', va='center', bbox=dict(facecolor='white', edgecolor='white', boxstyle='round,pad=.1'))\nplt.savefig('BW_Type_Legend.png', bbox_inches='tight')\nlvalues = [[50,50,50,50,50]]\nlvalues_colour = [[0,3,5,2,9]]\nlvalues_text = [['Local', 'Regional','National', 'International \\ Colonial','Undetermined']]\nlmax_cols = len(lvalues)\nlmax_rows = len(lvalues[0])\nlvalues_sums = [sum([r[i] for r in lvalues]) for i in range(lmax_rows)]\nlvalues_norm = [[v/lvalues_sums[i] for i, v in enumerate(row)] for row in lvalues]\nfig, ax = plt.subplots(1, figsize=(50, 2))\nfor row_num in range(lmax_cols):\n\tax.bar(range(lmax_rows), lvalues_norm[row_num], bottom=[sum([lvalues_norm[i][j] for i in range(row_num)]) for j in range(lmax_rows)], width=1, edgecolor='#000000',  color=[plt.get_cmap('Set1')(i) for i in lvalues_colour[row_num]])\nax.set_xlim(-0.5, lmax_rows-.5)\nax.set_xticks([])\nax.set_yticks([])\nax.set_ylim(0, 1)\nfor x in range(lmax_rows):\n\tfor y in range(lmax_cols):\n\t\tif lvalues[y][x] != 0.0:\n\t\t\tax.text(x, y + .5, lvalues_text[y][x], fontsize = 32, ha='center', va='center', bbox=dict(facecolor='white', edgecolor='white', boxstyle='round,pad=.1'))\nplt.savefig('Colour_Location_Legend.png', bbox_inches='tight')\n\nlvalues = [[50,50,50,50,50]]\nlvalues_colour = [[0,50,100,175,225]]\nlvalues_text = [['Local', 'Regional','National', 'International \\ Colonial','Undetermined']]\nlmax_cols = len(lvalues)\nlmax_rows = len(lvalues[0])\nlvalues_sums = [sum([r[i] for r in lvalues]) for i in range(lmax_rows)]\nlvalues_norm = [[v/lvalues_sums[i] for i, v in enumerate(row)] for row in lvalues]\nfig, ax = plt.subplots(1, figsize=(50, 2))\nfor row_num in range(lmax_cols):\n\tax.bar(range(lmax_rows), lvalues_norm[row_num], bottom=[sum([lvalues_norm[i][j] for i in range(row_num)]) for j in range(lmax_rows)], width=1, edgecolor='#000000',  color=[plt.get_cmap('Greys')(i) for i in lvalues_colour[row_num]])\nax.set_xlim(-0.5, lmax_rows-.5)\nax.set_xticks([])\nax.set_yticks([])\nax.set_ylim(0, 1)\nfor x in range(lmax_rows):\n\tfor y in range(lmax_cols):\n\t\tif lvalues[y][x] != 0.0:\n\t\t\tax.text(x, y + .5, lvalues_text[y][x], fontsize = 32, ha='center', va='center', bbox=dict(facecolor='white', edgecolor='white', boxstyle='round,pad=.1'))\nplt.savefig('BW_Location_Legend.png', bbox_inches='tight')\nlvalues = [[50],[50],[50],[50],[50]]\nlvalues_colour = [[0],[3],[5],[2],[9]]\nlvalues_text = [['Location Only'], ['Ambiguous Publication'],['Named Publication'],[ 'Correspondence'],['Undetermined']]\nlmax_cols = len(lvalues)\nlmax_rows = len(lvalues[0])\nlvalues_sums = [sum([r[i] for r in lvalues]) for i in range(lmax_rows)]\nlvalues_norm = [[v/lvalues_sums[i] for i, v in enumerate(row)] for row in lvalues]\nfig, ax = plt.subplots(1, figsize=(4, 20))\nfor row_num in range(lmax_cols):\n\tax.bar(range(lmax_rows), lvalues_norm[row_num], bottom=[sum([lvalues_norm[i][j] for i in range(row_num)]) for j in range(lmax_rows)], width=1, edgecolor='#000000',  color=[plt.get_cmap('Set1')(i) for i in lvalues_colour[row_num]])\nax.set_xlim(-0.5, lmax_rows-.5)\nax.set_xticks([])\nax.set_yticks([])\nax.set_ylim(0, 1)\nfor x in range(lmax_rows):\n\tfor y in range(lmax_cols):\n\t\tif lvalues[y][x] != 0.0:\n\t\t\tax.text(x, lvalues_norm[y][x] / 2 + sum([lvalues_norm[newy][x] for newy in range(y)]), lvalues_text[y][x], fontsize = 16, ha='center', va='center', bbox=dict(facecolor='white', edgecolor='white', boxstyle='round,pad=.1'))\nplt.savefig('Colour_Type_Legend_V.png', bbox_inches='tight')\n\nlvalues = [[50],[50],[50],[50],[50]]\nlvalues_colour = [[0],[50],[100],[160],[200]]\nlvalues_text = [['Location Only'], ['Ambiguous Publication'],['Named Publication'], ['Correspondence'],['Undetermined']]\nlmax_cols = len(lvalues)\nlmax_rows = len(lvalues[0])\nlvalues_sums = [sum([r[i] for r in lvalues]) for i in range(lmax_rows)]\nlvalues_norm = [[v/lvalues_sums[i] for i, v in enumerate(row)] for row in lvalues]\nfig, ax = plt.subplots(1, figsize=(4, 20))\nfor row_num in range(lmax_cols):\n\tax.bar(range(lmax_rows), lvalues_norm[row_num], bottom=[sum([lvalues_norm[i][j] for i in range(row_num)]) for j in range(lmax_rows)], width=1, edgecolor='#000000',  color=[plt.get_cmap('Greys')(i) for i in lvalues_colour[row_num]])\nax.set_xlim(-0.5, lmax_rows-.5)\nax.set_xticks([])\nax.set_yticks([])\nax.set_ylim(0, 1)\nfor x in range(lmax_rows):\n\tfor y in range(lmax_cols):\n\t\tif lvalues[y][x] != 0.0:\n\t\t\tax.text(x, lvalues_norm[y][x] / 2 + sum([lvalues_norm[newy][x] for newy in range(y)]), lvalues_text[y][x], fontsize = 16, ha='center', va='center', bbox=dict(facecolor='white', edgecolor='white', boxstyle='round,pad=.1'))\nplt.savefig('BW_Type_Legend_V.png', bbox_inches='tight')\n\nlvalues_text = [['Local'],['Regional'],['National'],[ 'International \\ Colonial'],['Undetermined']]\nlvalues = [[50],[50],[50],[50],[50]]\nlvalues_colour = [[0],[3],[5],[2],[9]]\nlmax_cols = len(lvalues)\nlmax_rows = len(lvalues[0])\nlvalues_sums = [sum([r[i] for r in lvalues]) for i in range(lmax_rows)]\nlvalues_norm = [[v/lvalues_sums[i] for i, v in enumerate(row)] for row in lvalues]\nfig, ax = plt.subplots(1, figsize=(4, 20))\nfor row_num in range(lmax_cols):\n\tax.bar(range(lmax_rows), lvalues_norm[row_num], bottom=[sum([lvalues_norm[i][j] for i in range(row_num)]) for j in range(lmax_rows)], width=1, edgecolor='#000000',  color=[plt.get_cmap('Set1')(i) for i in lvalues_colour[row_num]])\nax.set_xlim(-0.5, lmax_rows-.5)\nax.set_xticks([])\nax.set_yticks([])\nax.set_ylim(0, 1)\nfor x in range(lmax_rows):\n\tfor y in range(lmax_cols):\n\t\tif lvalues[y][x] != 0.0:\n\t\t\tax.text(x, lvalues_norm[y][x] / 2 + sum([lvalues_norm[newy][x] for newy in range(y)]), lvalues_text[y][x], fontsize = 16, ha='center', va='center', bbox=dict(facecolor='white', edgecolor='white', boxstyle='round,pad=.1'))\n\nplt.savefig('Colour_Location_Legend_V.png', bbox_inches='tight')\n\nlvalues_text = [['Local'],['Regional'],['National'],[ 'International \\ Colonial'],['Undetermined']]\nlvalues = [[50],[50],[50],[50],[50]]\nlvalues_colour = [[0],[50],[100],[160],[200]]\nlmax_cols = len(lvalues)\nlmax_rows = len(lvalues[0])\nlvalues_sums = [sum([r[i] for r in lvalues]) for i in range(lmax_rows)]\nlvalues_norm = [[v/lvalues_sums[i] for i, v in enumerate(row)] for row in lvalues]\nfig, ax = plt.subplots(1, figsize=(4, 20))\nfor row_num in range(lmax_cols):\n\tax.bar(range(lmax_rows), lvalues_norm[row_num], bottom=[sum([lvalues_norm[i][j] for i in range(row_num)]) for j in range(lmax_rows)], width=1, edgecolor='#000000',  color=[plt.get_cmap('Greys')(i) for i in lvalues_colour[row_num]])\nax.set_xlim(-0.5, lmax_rows-.5)\nax.set_xticks([])\nax.set_yticks([])\nax.set_ylim(0, 1)\nfor x in range(lmax_rows):\n\tfor y in range(lmax_cols):\n\t\tif lvalues[y][x] != 0.0:\n\t\t\tax.text(x, lvalues_norm[y][x] / 2 + sum([lvalues_norm[newy][x] for newy in range(y)]), lvalues_text[y][x], fontsize = 16, ha='center', va='center', bbox=dict(facecolor='white', edgecolor='white', boxstyle='round,pad=.1'))\n\nplt.savefig('BW_Location_Legend_V.png', bbox_inches='tight')";
